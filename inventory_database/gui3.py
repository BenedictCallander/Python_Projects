...
def add_product():
    ...
    c = conn.cursor()
    c.execute("INSERT INTO stock (name, price) VALUES (?, ?)", (entry_name.get(), entry_price.get()))
    conn.commit()
    conn.close()
    # clear entries
